...
labels= np.genfromtxt("./csv_data2/labels.csv",delimiter=",")
# grp = # Yet to be discovered
...
rng = np.arange(620,640) ## fingerprint information rich region of spectrum
